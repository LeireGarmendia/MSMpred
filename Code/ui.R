  ...
  dashboardBody(tags$head(includeHTML("google-analytics.html")),
    tabItems(
              ...
              navbarPage(title="Data",
                         ...
                         tabPanel("Filter",
                                  fluidRow(column(3,
                                           ...
                                           column(4,
                                                  actionBttn("save_filter", "Apply", style = "float", color = "primary"),
                                                  actionBttn("reset_filter", "Reset", style = "float", color = "primary")),
                                           column(2,
                                                  actionButton(inputId = 'ab111', label = HTML("<b>Help</b>"),
                                                               width = '100%',
                                                               icon = icon("list-alt"),
                         ...
                         tabPanel("Labels",
                                  ...
                                  fluidRow(column(3,
                                           ...
                                           column(3,
                                                  ...
                                                  actionBttn("save_state", "Save state label", style = "float", color = "primary")),
                                           column(3,
                                                  uiOutput("names_covar")),
                                           column(3,
                                                  textInput("text2", label = "Write the label:", value = "Enter text..."),
                                                  actionBttn("save_covar", "Save covariate label", style = "float", color = "primary")))),
      ...
      tabItem(tabName = "model", 
              actionBttn("save_model", "Save model specification", style = "float", color = "primary"),
              hr(),
              ...
              fluidRow(column(3, 
                       ...
                       column(6, 
                              p("You can use the search box to find the covariates related with a specific transition.",
                                style = "text-align:justify;color:black;background-color:lavender;padding:15px;border-radius:10px"),
                              box(title = "1) Table of model coefficients:", status = "warning", width = NULL,
                                  DT::dataTableOutput("model")),
                              box(title = "2) Table of likelihood:", status = "warning", width = NULL,
                                  DT::dataTableOutput("model_loglik"),
                                  DT::dataTableOutput("model_AIC")),
                              box(title = "3) Table of goodness of fit:", status = "warning", width = NULL,
      ...
      tabItem(tabName = "pred_perf", 
              fluidRow(column(3, 
                              actionBttn("LS", "Predictive performance", style = "float", color = "primary"),
                              #Progress bar
      ...
      tabItem(tabName = "comparison",
              ...
              box(title = "Save the models:", status = "warning", width = NULL,
                  actionBttn("save", "Save", style = "float", color = "primary"),
                  br(),
              ...
              box(title = "Load other models:", status = "warning", width = NULL,
                  ...
                  br(),
                  actionBttn("load", "Load", style = "float", color = "primary"))),
